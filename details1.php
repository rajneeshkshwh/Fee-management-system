...
<div class="panel-group" id="accordion">
 ...
 if(table == "data8"){
  ...
  document.getElementById("SVmno").value = r;
            ...
            <label>Registration Number</label><input type="text" class="form-control" name="RegistrationNumber" value="<?php echo $row['RegistrationNumber']; ?>" readonly>
            <label>Dob</label><input type="date" class="form-control" name="DOB" value="<?php echo $row['DOB']; ?>" readonly>
            <label>Fathers/Mother name</label><input type="text" class="form-control" name="FathersMothername" value="<?php echo $row['FathersMothername']; ?>" readonly>
             <label>Father's Phone</label><input type="text" class="form-control" name="ContactNumber2" value="<?php echo $row['ContactNumber2']; ?>" readonly>
            ...
            <label>Cast /Category</label><input type="text" class="form-control" name="Cast" value="<?php echo $row['Cast']; ?>" readonly>
            ...
            <label>Subject</label><input type="text" class="form-control" name="subject" value="<?php echo $row['subject']; ?>" readonly><br>
    ...
    <div class="panel panel-default">
      <div class="panel-heading">
        ...
        <div class="panel-body">
            <label>Gross Fees</label><input type="number" class="form-control" name="GrossFees" value="<?php echo $row['GrossFees']; ?>" readonly><br>
            <label>Paid Fees</label><input type="number" class="form-control" name="PaidFees" value="<?php echo $row['PaidFees']; ?>" readonly>
            <label>Concession Remark</label><input type="text" class="form-control" name="ConcessionRemark" value="<?php echo $row['ConcessionRemark']; ?>" readonly>
            <label>Remaining</label><input type="number" class="form-control" name="Remaining" value="<?php echo $row['Remaining']; ?>" readonly><br>
            <label>Practical Fees</label><input type="text" class="form-control" name="PracticalFees" value="<?php echo $row['PracticalFees']; ?>" readonly>
           
            <label>TC/CC/Bonafide Degree (For final year student Only.)</label>
            <input type="text" class="form-control" id="TCCCBonafideDegree" value="<?php echo $row['TCCCBonafide']; ?>" readonly>
  ...
  <div class="form-group">
    <button type="submit" name="reupdate" class="btn btn-primary">Save</button>
    <a href="edit1.php?edit=<?php echo $row['id']; ?>" class="btn btn-info">EDIT</a>
    <a href="student.php" class="btn btn-warning">HOME</a>
  </div>
  </form>
</div>
</div>

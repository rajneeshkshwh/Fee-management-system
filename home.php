...
<div class="container">
<form class="form-inline d-flex justify-content-center md-form form-sm active-purple-2 mt-2" action="home.php" method="POST">
...
<form action="add.php">
    <a href="audit.php" class="btn btn-primary">Revenue</a>
	<a href="log.php" class="btn btn-primary">LOG</a>
				...
				<table class="table">
					<thead>
						...
						<tr>
							...
							<td>
							    <a href="details.php?view=<?php echo $row['id']; ?>" class="btn btn-primary">View Details</a>

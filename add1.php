...
<body>
  <a href="student.php" class="btn btn-warning" style="float:right; margin-top:32px; margin-right:12px;">Cancel</a>
...
<hr><hr>
  ...
  <form action="process1.php" enctype="multipart/form-data" method="POST">
    ...
    <div class="panel panel-default">
      <div class="panel-heading">
        ...
        <div class="panel-body">
            ...
            <label>Registration Number</label><input type="text" class="form-control" name="RegistrationNumber" placeholder ="Enter Registration Number" required>
    ...
    <div class="panel panel-default">
      <div class="panel-heading">
        ...
        <div class="panel-body">
            ...
            <label>Concession Remark</label><input type="text" class="form-control" name="ConcessionRemark" id="ConcessionRemark" placeholder ="Enter with name" value="0" >
  ...
  <script>
   ...
   <script>
      ...
      var z = document.getElementById("PaidFees").value;
       x = document.getElementById("ConcessionRemark").value;
      var d = x.match(/(\d+)/);

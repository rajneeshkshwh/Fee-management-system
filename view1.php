...
<body>
    <a href="search.php" class="btn btn-warning" style="float:right; margin-top:32px; margin-right:12px;">Back</a>
    <div class="container">
				...
				<table class="table">
					<thead>
						...
						<tr>
							...
							<td>
							    <a href="details1.php?view=<?php echo $row['id']; ?>" class="btn btn-primary">Details</a>
